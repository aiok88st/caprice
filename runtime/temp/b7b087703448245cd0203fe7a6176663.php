<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\wamp\www\caprice/app/admin\view\content\enproductList.html";i:1506594131;s:51:"F:\wamp\www\caprice/app/admin\view\common\head.html";i:1505459050;s:51:"F:\wamp\www\caprice/app/admin\view\common\foot.html";i:1503623995;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use('table', function() {
        ...
        table.on('tool(list)', function(obj) {
            ...
            if(obj.event === 'del'){
                ...
                var loading = layer.load(1, {shade: [0.1, '#fff']});
                $.post('<?php echo url("addHots"); ?>', {'id': data.id}, function (res) {
                    layer.close(loading);
                    if (res.code===1) {
                        if (res.status === 1) {
                            obj.update({
